function rank(win, lose) {
    ...
    let levelRank = function(){
        ...
        if(wins > 10 && wins < 21) return "Bronze";
        if(wins > 20 && wins < 51) return "Prata";
        if(wins > 50 && wins < 81) return "Ouro";
        if(wins > 80 && wins < 91) return "Diamante";
        if(wins > 90 && wins < 101) return "Lendário";
        if(wins > 100) return "Imortal";
    }
